...
names = ["nation", "lineitem", "orders", "part", "partsupp", "region", "supplier", "customer"]


for n in names:
    convert_csv_to_parquet(
    csv_file_path=Path('./csv/' + n + '.csv'),
    parquet_file_path=Path('./parquet/' + n + '.parquet'),
    max_ram_mb_per_chunk=1000, sep=",", encoding="utf8")
